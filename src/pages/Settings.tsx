    ...
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="auto_mode" className="ml-2 block text-sm text-gray-700">
                    启用自动模式
                  </label>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <input
                    ...
                    checked={settings.emergency_priority}
                    onChange={(e) => setSettings({ ...settings, emergency_priority: e.target.checked })}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="emergency_priority" className="ml-2 block text-sm text-gray-700">
                    启用紧急车辆优先
                  </label>
                </div>
                <p className="text-sm text-gray-500 ml-6">
                  为紧急车辆（救护车、消防车、警车）提供优先通行
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  min="10"
                  max="120"
                  value={settings.min_cycle_length}
                  onChange={(e) => setSettings({ ...settings, min_cycle_length: parseInt(e.target.value) })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="mt-1 text-sm text-gray-500">
                  红绿灯周期的最小长度
          ...
          {/* 检测设置 */}
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">检测设置</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  min="10"
                  max="500"
                  value={settings.detection_radius}
                  onChange={(e) => setSettings({ ...settings, detection_radius: parseInt(e.target.value) })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="mt-1 text-sm text-gray-500">
                  车辆检测器的有效范围
            ...
            <div className="space-y-6">
              ...
              {params && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">低流量阈值 (辆)</label>
                    <input
                      type="number"
                      min={0}
                      max={100}
